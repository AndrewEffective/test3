...
function create_my_taxonomies() {
    register_taxonomy(
        ...
        array(
            'labels' => array(
                'name' => 'Books cathegories',
                'add_new_item' => 'Add new',
                'new_item_name' => "New cathegorie"
            ),
            'public' => true,
...
function register_post_types(){
    register_post_type('ourbooks', array(
        'label'  => null,
        'labels' => array(
            'name'               => 'Books', // основное название для типа записи
            'singular_name'      => 'Books', // название для одной записи этого типа
            ...
            'view_item'          => 'View book', // для просмотра записи этого типа.
            'search_items'       => 'search', // для поиска по этим типам записи
            'not_found'          => 'not_found', // если в результате поиска ничего не было найдено
            'not_found_in_trash' => 'not_found', // если не было найдено в корзине
